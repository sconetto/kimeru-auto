...
import { brands, specCategories, vehicleCategories } from "@/lib/db/schema";
import { AiImportForm } from "./ai-import-form";

export const dynamic = "force-dynamic";

export default async function AiImportPage() {
  const [allBrands, categories, specCats] = await Promise.all([
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <AiImportForm brands={allBrands} categories={categories} specCategories={specCats} />
    </div>
  );
}
